...
do
LOGNAME_t0=pmo-concept_w4_.5-1st_p4-coda-l8-concept${target_concept_id}-task0
LOGNAME=pmo-concept_w4_.5-1st_p4-coda-l8-concept${target_concept_id}
